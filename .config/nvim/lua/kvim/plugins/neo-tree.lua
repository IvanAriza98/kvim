return {
	...
	config = function()
		require("neo-tree").setup({
			...
			enable_diagnostics = false, -- active if you want to see diagnostics in the tree
			...
			document_symbols = {
				window = {
					mappings = {
						...
						["l"] = "toggle_node", -- if you want expand/close symbolsi quieres expandir/cerrar símbolos
						["h"] = "toggle_node",
					},
				},
			},
