...
function M.setup()
    ...
    pcall(vim.api.nvim_del_user_command, "KvimWorkspaceClear")
    ...
    vim.api.nvim_create_user_command("KvimWorkspaceClear", function()
        actions.clear.callback()
    end, {
        nargs = 0,
        desc = "Clear current KVIM workspace",
    })
